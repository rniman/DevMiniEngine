...
)
{
	...
	// 큐브 정점 데이터 (8개 정점, 36개 인덱스)
	Graphics::BasicVertex cubeVertices[] =
	{
		// Front face (Red)
		{ Math::Vector3(-2.0f,  2.0f, -2.0f), Math::Vector4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ Math::Vector3(2.0f,  2.0f, -2.0f), Math::Vector4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ Math::Vector3(-2.0f, -2.0f, -2.0f), Math::Vector4(1.0f, 0.0f, 0.0f, 1.0f) },
		{ Math::Vector3(2.0f, -2.0f, -2.0f), Math::Vector4(1.0f, 0.0f, 0.0f, 1.0f) },

		// Back face (Green)
		{ Math::Vector3(-2.0f,  2.0f,  2.0f), Math::Vector4(0.0f, 1.0f, 0.0f, 1.0f) },
		{ Math::Vector3(2.0f,  2.0f,  2.0f), Math::Vector4(0.0f, 1.0f, 0.0f, 1.0f) },
		{ Math::Vector3(-2.0f, -2.0f,  2.0f), Math::Vector4(0.0f, 1.0f, 0.0f, 1.0f) },
		{ Math::Vector3(2.0f, -2.0f,  2.0f), Math::Vector4(0.0f, 1.0f, 0.0f, 1.0f) }
	};
