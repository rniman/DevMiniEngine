...
namespace Platform
{
	...
	public:
		...
		//=============================================================================
		// ImGui 입력 소비 확인 (Debug 빌드에서만 유효)
		//=============================================================================

		/**
		 * @brief 마우스 입력이 게임에서 사용 가능한지 확인
		 *
		 * ImGui가 마우스를 사용 중이면 false 반환
		 * Release 빌드에서는 항상 true 반환
		 */
		bool IsMouseAvailable() const;

		/**
		 * @brief 키보드 입력이 게임에서 사용 가능한지 확인
		 *
		 * ImGui가 키보드를 사용 중이면 false 반환
		 * Release 빌드에서는 항상 true 반환
		 */
